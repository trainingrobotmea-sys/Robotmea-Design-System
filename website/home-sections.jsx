...
function HomeTrust() {
  const partners = [
    { src: "../assets/partners/robotron.png",  alt: "Robotron",  role: "Accreditation",       c: "var(--rm-orange)" },
    { src: "../assets/partners/minirobot.png", alt: "MiniRobot", role: "Robotics Hardware",   c: "var(--rm-blue)" },
    { src: "../assets/partners/neopia.png",    alt: "Neopia",    role: "EdTech Systems",      c: "var(--rm-green)" },
...
function HomePrincipals() {
  const steps = [
    ...
    {
      n: "03", t: "Adopt the Curriculum", color: "var(--rm-green)",
    ...
    {
      n: "04", t: "Train Your Teachers", color: "var(--rm-red)",
