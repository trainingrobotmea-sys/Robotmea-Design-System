    ...
    <section className="rm-copr-hero" data-screen-label="01 COPR Hero">
      ...
      <div className="rm-container rm-copr-hero__inner">
        <div className="rm-copr-hero__layout">
          <div className="rm-copr-hero__title-wrap">
            <div className="rm-eyebrow rm-eyebrow--white">Communication, Outreach and Public Relation Nexus</div>
            <h1 className="rm-copr-hero__title">
              COPR <span className="rm-copr-hero__title-accent">Nexus.</span>
            </h1>
...
function CoprFlagshipEvents() {
  const events = [
    ...
    { c: "var(--rm-orange)", t: "Young Empowerment Program",
