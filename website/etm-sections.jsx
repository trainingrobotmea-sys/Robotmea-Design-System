    ...
    <section className="rm-etm-hero" data-screen-label="01 ETM Hero">
      ...
      <div className="rm-container rm-etm-hero__inner">
        <div className="rm-etm-hero__layout">
          <div>
            <div className="rm-etm-hero__brand">
              <span className="rm-etm-hero__brand-tag">E</span>
              <span className="rm-etm-hero__brand-txt">Educational Transformation Movement</span>
            </div>
